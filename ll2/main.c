...
prepareKernel(
	 ...
	 *
	 * TODO: Define and document i, k, fBlock, nKernelBlocks
	 */
	 ...
	 *
	 * Because we cleared the entire kernel block here, the kernel may be shorter than the actual amount of memory
	 * allocated but that's OK, becuase the remainder will be nulled to zero and the total amount of memory allocated will
	 * be a power of two number of frames.
	 */
